const PhilosophySection = () => {
  ...
  return <section className="py-24 md:py-32 section-padding bg-secondary/40 relative overflow-hidden">
      {/* Decorative Elements */}
      ...
      <div className="max-w-7xl mx-auto relative">
        ...
        <div className="grid md:grid-cols-3 gap-8 md:gap-12">
          {values.map((value, index) => <article key={value.number} className="group relative" style={{
